...
export default class Bar extends React.Component {
  ...
  _handleClick(d) {
    console.log(d);
    sessionStorage.setItem('reflectionDate', d.date);
    if (d.logCount > 0) {
      sessionStorage.setItem('popoverMessage', 'Good work!');
    } else {
      sessionStorage.setItem('popoverMessage', 'Oh well, no worries here!');
    }
    sessionStorage.setItem('eventCount', d.logCount);
